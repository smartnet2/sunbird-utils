...
public enum ResponseCode {
    ...
    invalidUserCredentials(ResponseMessage.Key.INVALID_USER_CREDENTIALS,
    ...
    customerIdRequired(ResponseMessage.Key.CONSUMER_ID_INVALID_ERROR,
    ...
    errorInvalidConfigParamValue(ResponseMessage.Key.ERROR_INVALID_CONFIG_PARAM_VALUE,
            ResponseMessage.Message.ERROR_INVALID_CONFIG_PARAM_VALUE),
    errorMaxSizeExceeded(ResponseMessage.Key.ERROR_MAX_SIZE_EXCEEDED, ResponseMessage.Message.ERROR_MAX_SIZE_EXCEEDED),
    ...
    courseVersionRequiredError(ResponseMessage.Key.COURSE_VERSION_MISSING,
            ResponseMessage.Message.COURSE_VERSION_MISSING),
    contentVersionRequiredError(ResponseMessage.Key.CONTENT_VERSION_MISSING,
            ResponseMessage.Message.CONTENT_VERSION_MISSING),
    ...
    organisationIdRequiredError(ResponseMessage.Key.ORGANISATION_ID_MISSING,
            ResponseMessage.Message.ORGANISATION_ID_MISSING),
    sourceAndExternalIdValidationError(ResponseMessage.Key.REQUIRED_DATA_ORG_MISSING,
    ...
    channelUniquenessInvalid(ResponseMessage.Key.CHANNEL_SHOULD_BE_UNIQUE,
            ResponseMessage.Message.CHANNEL_SHOULD_BE_UNIQUE),
    errorDuplicateEntry(ResponseMessage.Key.ERROR_DUPLICATE_ENTRY, ResponseMessage.Message.ERROR_DUPLICATE_ENTRY),
    unableToConnect(ResponseMessage.Key.UNABLE_TO_CONNECT_TO_EKSTEP,
    ...
    invalidRootOrganisationId(ResponseMessage.Key.INVALID_ROOT_ORGANIZATION,
            ResponseMessage.Message.INVALID_ROOT_ORGANIZATION),
    invalidParentId(ResponseMessage.Key.INVALID_PARENT_ORGANIZATION_ID,
            ResponseMessage.Message.INVALID_PARENT_ORGANIZATION_ID),
    cyclicValidationError(ResponseMessage.Key.CYCLIC_VALIDATION_FAILURE,
    ...
    usrValidationError(ResponseMessage.Key.USR_DATA_VALIDATION_ERROR,
    ...
    enrollmentStartDateRequiredError(ResponseMessage.Key.ENROLLMENT_START_DATE_MISSING,
            ResponseMessage.Message.ENROLLMENT_START_DATE_MISSING),
    courseDurationRequiredError(ResponseMessage.Key.COURSE_DURATION_MISSING,
    ...
    userNameCanntBeUpdated(ResponseMessage.Key.USERNAME_CANNOT_BE_UPDATED,
    ...
    publishedCourseCanNotBeUpdated(ResponseMessage.Key.PUBLISHED_COURSE_CAN_NOT_UPDATED,
    ...
    sectionDataTypeRequired(ResponseMessage.Key.SECTION_DATA_TYPE_MISSING,
    ...
    assessmentItemIdRequired(ResponseMessage.Key.ASSESSMENT_ITEM_ID_REQUIRED,
            ResponseMessage.Message.ASSESSMENT_ITEM_ID_REQUIRED),
    assessmentTypeRequired(ResponseMessage.Key.ASSESSMENT_TYPE_REQUIRED,
            ResponseMessage.Message.ASSESSMENT_TYPE_REQUIRED),
    assessmentAttemptDateRequired(ResponseMessage.Key.ATTEMPTED_DATE_REQUIRED,
            ResponseMessage.Message.ATTEMPTED_DATE_REQUIRED),
    assessmentAnswersRequired(ResponseMessage.Key.ATTEMPTED_ANSWERS_REQUIRED,
    ...
    statusCanntBeUpdated(ResponseMessage.Key.STATUS_CANNOT_BE_UPDATED,
    ...
    emailANDUserNameAlreadyExistError(ResponseMessage.Key.USERNAME_EMAIL_IN_USE,
            ResponseMessage.Message.USERNAME_EMAIL_IN_USE),
    keyCloakDefaultError(ResponseMessage.Key.KEY_CLOAK_DEFAULT_ERROR, ResponseMessage.Message.KEY_CLOAK_DEFAULT_ERROR),
    userRegUnSuccessfull(ResponseMessage.Key.USER_REG_UNSUCCESSFUL, ResponseMessage.Message.USER_REG_UNSUCCESSFUL),
    userUpdationUnSuccessfull(ResponseMessage.Key.USER_UPDATE_UNSUCCESSFUL,
    ...
    invalidOrgStatusTransition(ResponseMessage.Key.INVALID_ORG_STATUS_TRANSITION,
    ...
    jobDetailsRequired(ResponseMessage.Key.JOBDETAILS_REQUIRED_ERROR,
    ...
    userAlreadyExists(ResponseMessage.Key.USER_ALREADY_EXISTS, ResponseMessage.Message.USER_ALREADY_EXISTS),
    ...
    contentStatusRequired(ResponseMessage.Key.CONTENT_STATUS_MISSING_ERROR,
    ...
    educationNameError(ResponseMessage.Key.NAME_OF_INSTITUTION_ERROR,
    ...
    organisationNameError(ResponseMessage.Key.NAME_OF_ORGANISATION_ERROR,
    ...
    emptyRolesProvided(ResponseMessage.Key.EMPTY_ROLES_PROVIDED, ResponseMessage.Message.EMPTY_ROLES_PROVIDED),
    invalidDateFormat(ResponseMessage.Key.INVALID_DATE_FORMAT, ResponseMessage.Message.INVALID_DATE_FORMAT),
    sourceAndExternalIdAlreadyExist(ResponseMessage.Key.SRC_EXTERNAL_ID_ALREADY_EXIST,
            ResponseMessage.Message.SRC_EXTERNAL_ID_ALREADY_EXIST),
    userAlreadyEnrolledCourse(ResponseMessage.Key.USER_ALREADY_ENROLLED_COURSE,
            ResponseMessage.Message.USER_ALREADY_ENROLLED_COURSE),
    userNotEnrolledCourse(ResponseMessage.Key.USER_NOT_ENROLLED_COURSE,
            ResponseMessage.Message.USER_NOT_ENROLLED_COURSE),
    courseBatchAlreadyCompleted(ResponseMessage.Key.COURSE_BATCH_ALREADY_COMPLETED,
            ResponseMessage.Message.COURSE_BATCH_ALREADY_COMPLETED),
    userAlreadyCompletedCourse(ResponseMessage.Key.USER_ALREADY_COMPLETED_COURSE,
    ...
    userAlreadyInactive(ResponseMessage.Key.USER_ALREADY_INACTIVE, ResponseMessage.Message.USER_ALREADY_INACTIVE),
    enrolmentTypeRequired(ResponseMessage.Key.ENROLMENT_TYPE_REQUIRED, ResponseMessage.Message.ENROLMENT_TYPE_REQUIRED),
    enrolmentIncorrectValue(ResponseMessage.Key.ENROLMENT_TYPE_VALUE_ERROR,
    ...
    courseBatchStartDateError(ResponseMessage.Key.COURSE_BATCH_START_DATE_INVALID,
    ...
    enrollmentTypeValidation(ResponseMessage.Key.ENROLLMENT_TYPE_VALIDATION,
            ResponseMessage.Message.ENROLLMENT_TYPE_VALIDATION),
    courseCreatedForIsNull(ResponseMessage.Key.COURSE_CREATED_FOR_NULL,
            ResponseMessage.Message.COURSE_CREATED_FOR_NULL),
    userNotAssociatedToOrg(ResponseMessage.Key.USER_NOT_BELONGS_TO_ANY_ORG,
    ...
    courseBatchStartPassedDateError(ResponseMessage.Key.COURSE_BATCH_START_PASSED_DATE_INVALID,
    ...
    smsBodyError(ResponseMessage.Key.SMS_BODY_ERROR, ResponseMessage.Message.SMS_BODY_ERROR),
    ...
    storageContainerNameMandatory(ResponseMessage.Key.STORAGE_CONTAINER_NAME_MANDATORY,
            ResponseMessage.Message.STORAGE_CONTAINER_NAME_MANDATORY),
    userOrgAssociationError(ResponseMessage.Key.USER_ORG_ASSOCIATION_ERROR,
    ...
    orgTypeIdRequired(ResponseMessage.Key.ORG_TYPE_ID_REQUIRED_ERROR,
    ...
    userDataEncryptionError(ResponseMessage.Key.USER_DATA_ENCRYPTION_ERROR,
    ...
    invalidBatchEndDateError(ResponseMessage.Key.INVALID_BATCH_END_DATE_ERROR,
            ResponseMessage.Message.INVALID_BATCH_END_DATE_ERROR),
    invalidBatchStartDateError(ResponseMessage.Key.INVALID_BATCH_START_DATE_ERROR,
            ResponseMessage.Message.INVALID_BATCH_START_DATE_ERROR),
    courseBatchEndDateError(ResponseMessage.Key.COURSE_BATCH_END_DATE_ERROR,
            ResponseMessage.Message.COURSE_BATCH_END_DATE_ERROR),
    BatchCloseError(ResponseMessage.Key.COURSE_BATCH_IS_CLOSED_ERROR,
            ResponseMessage.Message.COURSE_BATCH_IS_CLOSED_ERROR),
    newPasswordRequired(ResponseMessage.Key.CONFIIRM_PASSWORD_MISSING,
    ...
    endorsedUserIdRequired(ResponseMessage.Key.ENDORSED_USER_ID_REQUIRED,
    ...
    userPhoneUpdateFailed(ResponseMessage.Key.USER_PHONE_UPDATE_FAILED,
    ...
    visibilityInvalid(ResponseMessage.Key.INVALID_VISIBILITY_REQUEST,
    ...
    invalidNotificationType(ResponseMessage.Key.INVALID_NOTIFICATION_TYPE,
            ResponseMessage.Message.INVALID_NOTIFICATION_TYPE),
    notificationTypeSupport(ResponseMessage.Key.INVALID_NOTIFICATION_TYPE_SUPPORT,
    ...
    userNameOrUserIdRequired(ResponseMessage.Key.USERNAME_USERID_MISSING,
            ResponseMessage.Message.USERNAME_USERID_MISSING),
    channelRegFailed(ResponseMessage.Key.CHANNEL_REG_FAILED, ResponseMessage.Message.CHANNEL_REG_FAILED),
    invalidCourseCreatorId(ResponseMessage.Key.INVALID_COURSE_CREATOR_ID,
            ResponseMessage.Message.INVALID_COURSE_CREATOR_ID),
    userNotAssociatedToRootOrg(ResponseMessage.Key.USER_NOT_ASSOCIATED_TO_ROOT_ORG,
    ...
    invalidDataForCreateBadgeIssuer(ResponseMessage.Key.INVALID_CREATE_BADGE_ISSUER_DATA,
    ...
    badgeDescriptionRequired(ResponseMessage.Key.BADGE_DESCRIPTION_REQUIRED,
    ...
    invalidBadgeType(ResponseMessage.Key.INVALID_BADGE_TYPE, ResponseMessage.Message.INVALID_BADGE_TYPE),
    invalidBadgeSubtype(ResponseMessage.Key.INVALID_BADGE_SUBTYPE, ResponseMessage.Message.INVALID_BADGE_SUBTYPE),
    invalidBadgeRole(ResponseMessage.Key.INVALID_BADGE_ROLE, ResponseMessage.Message.INVALID_BADGE_ROLE),
    ...
    recipientEmailRequired(ResponseMessage.Key.RECIPIENT_EMAIL_REQUIRED,
            ResponseMessage.Message.RECIPIENT_EMAIL_REQUIRED),
    evidenceRequired(ResponseMessage.Key.ASSERTION_EVIDENCE_REQUIRED,
            ResponseMessage.Message.ASSERTION_EVIDENCE_REQUIRED),
    assertionIdRequired(ResponseMessage.Key.ASSERTION_ID_REQUIRED, ResponseMessage.Message.ASSERTION_ID_REQUIRED),
    ...
    sizeLimitExceed(ResponseMessage.Key.MAX_ALLOWED_SIZE_LIMIT_EXCEED,
    ...
    revocationReasonRequired(ResponseMessage.Key.REVOCATION_REASON_REQUIRED,
    ...
    customResourceNotFound(ResponseMessage.Key.CUSTOM_RESOURCE_NOT_FOUND_ERROR,
    ...
    userInactiveForThisOrg(ResponseMessage.Key.USER_INACTIVE_FOR_THIS_ORG,
            ResponseMessage.Message.USER_INACTIVE_FOR_THIS_ORG),
    userUpdateToOrgFailed(ResponseMessage.Key.USER_UPDATE_FAILED_FOR_THIS_ORG,
            ResponseMessage.Message.USER_UPDATE_FAILED_FOR_THIS_ORG),
    preferenceKeyMissing(ResponseMessage.Key.USER_UPDATE_FAILED_FOR_THIS_ORG,
            ResponseMessage.Message.USER_UPDATE_FAILED_FOR_THIS_ORG),
    ...
    invalidPageSource(ResponseMessage.Key.INVALID_PAGE_SOURCE, ResponseMessage.Message.INVALID_PAGE_SOURCE),
    badgeSubTypeRequired(ResponseMessage.Key.BADGE_SUBTYPE_REQUIRED, ResponseMessage.Message.BADGE_SUBTYPE_REQUIRED),
    locationTypeRequired(ResponseMessage.Key.LOCATION_TYPE_REQUIRED, ResponseMessage.Message.LOCATION_TYPE_REQUIRED),
    invalidRequestDataForLocation(ResponseMessage.Key.INVALID_REQUEST_DATA_FOR_LOCATION,
    ...
    parentCodeAndIdValidationError(ResponseMessage.Key.PARENT_CODE_AND_PARENT_ID_MISSING,
            ResponseMessage.Message.PARENT_CODE_AND_PARENT_ID_MISSING),
    invalidParameter(ResponseMessage.Key.INVALID_PARAMETER, ResponseMessage.Message.INVALID_PARAMETER),
    invalidLocationDeleteRequest(ResponseMessage.Key.INVALID_LOCATION_DELETE_REQUEST,
            ResponseMessage.Message.INVALID_LOCATION_DELETE_REQUEST),
    locationTypeConflicts(ResponseMessage.Key.LOCATION_TYPE_CONFLICTS, ResponseMessage.Message.LOCATION_TYPE_CONFLICTS),
    mandatoryParamsMissing(ResponseMessage.Key.MANDATORY_PARAMETER_MISSING,
            ResponseMessage.Message.MANDATORY_PARAMETER_MISSING),
    errorMandatoryParamsEmpty(ResponseMessage.Key.ERROR_MANDATORY_PARAMETER_EMPTY,
            ResponseMessage.Message.ERROR_MANDATORY_PARAMETER_EMPTY),
    errorNoFrameworkFound(ResponseMessage.Key.ERROR_NO_FRAMEWORK_FOUND,
            ResponseMessage.Message.ERROR_NO_FRAMEWORK_FOUND),
    unupdatableField(ResponseMessage.Key.UPDATE_NOT_ALLOWED, ResponseMessage.Message.UPDATE_NOT_ALLOWED),
    mandatoryHeadersMissing(ResponseMessage.Key.MANDATORY_HEADER_MISSING,
            ResponseMessage.Message.MANDATORY_HEADER_MISSING),
    invalidParameterValue(ResponseMessage.Key.INVALID_PARAMETER_VALUE, ResponseMessage.Message.INVALID_PARAMETER_VALUE),
    parentNotAllowed(ResponseMessage.Key.PARENT_NOT_ALLOWED, ResponseMessage.Message.PARENT_NOT_ALLOWED),
    missingFileAttachment(ResponseMessage.Key.MISSING_FILE_ATTACHMENT, ResponseMessage.Message.MISSING_FILE_ATTACHMENT),
    fileAttachmentSizeNotConfigured(ResponseMessage.Key.FILE_ATTACHMENT_SIZE_NOT_CONFIGURED,
    ...
    conflictingOrgLocations(ResponseMessage.Key.CONFLICTING_ORG_LOCATIONS,
            ResponseMessage.Message.CONFLICTING_ORG_LOCATIONS),
    unableToCommunicateWithActor(ResponseMessage.Key.UNABLE_TO_COMMUNICATE_WITH_ACTOR,
    ...
    invalidRequestParameter(ResponseMessage.Key.INVALID_REQUEST_PARAMETER,
            ResponseMessage.Message.INVALID_REQUEST_PARAMETER),
    rootOrgAssociationError(ResponseMessage.Key.ROOT_ORG_ASSOCIATION_ERROR,
            ResponseMessage.Message.ROOT_ORG_ASSOCIATION_ERROR),
    dependentParameterMissing(ResponseMessage.Key.DEPENDENT_PARAMETER_MISSING,
            ResponseMessage.Message.DEPENDENT_PARAMETER_MISSING),
    externalIdNotFound(ResponseMessage.Key.EXTERNALID_NOT_FOUND, ResponseMessage.Message.EXTERNALID_NOT_FOUND),
    externalIdAssignedToOtherUser(ResponseMessage.Key.EXTERNALID_ASSIGNED_TO_OTHER_USER,
            ResponseMessage.Message.EXTERNALID_ASSIGNED_TO_OTHER_USER),
    dependentParamsMissing(ResponseMessage.Key.DEPENDENT_PARAMETER_MISSING,
            ResponseMessage.Message.DEPENDENT_PARAMS_MISSING),
    mandatoryConfigParamMissing(ResponseMessage.Key.MANDATORY_CONFIG_PARAMETER_MISSING,
            ResponseMessage.Message.MANDATORY_CONFIG_PARAMETER_MISSING),
    cassandraConnectionEstablishmentFailed(ResponseMessage.Key.CASSANDRA_CONNECTION_ESTABLISHMENT_FAILED,
            ResponseMessage.Message.CASSANDRA_CONNECTION_ESTABLISHMENT_FAILED),
    commonAttributeMismatch(ResponseMessage.Key.COMMON_ATTRIBUTE_MISMATCH,
            ResponseMessage.Message.COMMON_ATTRIBUTE_MISMATCH),
    multipleCoursesNotAllowedForBatch(ResponseMessage.Key.MULTIPLE_COURSES_FOR_BATCH,
            ResponseMessage.Message.MULTIPLE_COURSES_FOR_BATCH),
    errorJsonTransformInvalidTypeConfig(ResponseMessage.Key.ERROR_JSON_TRANSFORM_INVALID_TYPE_CONFIG,
            ResponseMessage.Message.ERROR_JSON_TRANSFORM_INVALID_TYPE_CONFIG),
    errorJsonTransformInvalidDateFormat(ResponseMessage.Key.ERROR_JSON_TRANSFORM_INVALID_DATE_FORMAT,
            ResponseMessage.Message.ERROR_JSON_TRANSFORM_INVALID_DATE_FORMAT),
    errorJsonTransformInvalidInput(ResponseMessage.Key.ERROR_JSON_TRANSFORM_INVALID_INPUT,
            ResponseMessage.Message.ERROR_JSON_TRANSFORM_INVALID_INPUT),
    errorJsonTransformInvalidEnumInput(ResponseMessage.Key.ERROR_JSON_TRANSFORM_INVALID_ENUM_INPUT,
            ResponseMessage.Message.ERROR_JSON_TRANSFORM_INVALID_ENUM_INPUT),
    errorJsonTransformEnumValuesEmpty(ResponseMessage.Key.ERROR_JSON_TRANSFORM_ENUM_VALUES_EMPTY,
            ResponseMessage.Message.ERROR_JSON_TRANSFORM_ENUM_VALUES_EMPTY),
    errorJsonTransformBasicConfigMissing(ResponseMessage.Key.ERROR_JSON_TRANSFORM_BASIC_CONFIG_MISSING,
    ...
    errorRegistryClientCreation(ResponseMessage.Key.ERROR_REGISTRY_CLIENT_CREATION,
            ResponseMessage.Message.ERROR_REGISTRY_CLIENT_CREATION),
    errorRegistryAddEntity(ResponseMessage.Key.ERROR_REGISTRY_ADD_ENTITY,
    ...
    errorRegistryUpdateEntity(ResponseMessage.Key.ERROR_REGISTRY_UPDATE_ENTITY,
            ResponseMessage.Message.ERROR_REGISTRY_UPDATE_ENTITY),
    errorRegistryDeleteEntity(ResponseMessage.Key.ERROR_REGISTRY_DELETE_ENTITY,
            ResponseMessage.Message.ERROR_REGISTRY_DELETE_ENTITY),
    errorRegistryParseResponse(ResponseMessage.Key.ERROR_REGISTRY_PARSE_RESPONSE,
            ResponseMessage.Message.ERROR_REGISTRY_PARSE_RESPONSE),
    errorRegistryEntityTypeBlank(ResponseMessage.Key.ERROR_REGISTRY_ENTITY_TYPE_BLANK,
            ResponseMessage.Message.ERROR_REGISTRY_ENTITY_TYPE_BLANK),
    errorRegistryEntityIdBlank(ResponseMessage.Key.ERROR_REGISTRY_ENTITY_ID_BLANK,
            ResponseMessage.Message.ERROR_REGISTRY_ENTITY_ID_BLANK),
    errorRegistryAccessTokenBlank(ResponseMessage.Key.ERROR_REGISTRY_ACCESS_TOKEN_BLANK,
            ResponseMessage.Message.ERROR_REGISTRY_ACCESS_TOKEN_BLANK),
    duplicateExternalIds(ResponseMessage.Key.DUPLICATE_EXTERNAL_IDS, ResponseMessage.Message.DUPLICATE_EXTERNAL_IDS),
    invalidDuplicateValue(ResponseMessage.Key.INVALID_DUPLICATE_VALUE, ResponseMessage.Message.INVALID_DUPLICATE_VALUE),
    emailNotSentRecipientsExceededMaxLimit(ResponseMessage.Key.EMAIL_RECIPIENTS_EXCEEDS_MAX_LIMIT,
            ResponseMessage.Message.EMAIL_RECIPIENTS_EXCEEDS_MAX_LIMIT),
    emailNotSentRecipientsZero(ResponseMessage.Key.NO_EMAIL_RECIPIENTS, ResponseMessage.Message.NO_EMAIL_RECIPIENTS),
    parameterMismatch(ResponseMessage.Key.PARAMETER_MISMATCH, ResponseMessage.Message.PARAMETER_MISMATCH),
    errorForbidden(ResponseMessage.Key.FORBIDDEN, ResponseMessage.Message.FORBIDDEN),
    errorConfigLoadEmptyString(ResponseMessage.Key.ERROR_CONFIG_LOAD_EMPTY_STRING,
            ResponseMessage.Message.ERROR_CONFIG_LOAD_EMPTY_STRING),
    errorConfigLoadParseString(ResponseMessage.Key.ERROR_CONFIG_LOAD_PARSE_STRING,
            ResponseMessage.Message.ERROR_CONFIG_LOAD_PARSE_STRING),
    errorConfigLoadEmptyConfig(ResponseMessage.Key.ERROR_CONFIG_LOAD_EMPTY_CONFIG,
            ResponseMessage.Message.ERROR_CONFIG_LOAD_EMPTY_CONFIG),
    errorConflictingFieldConfiguration(ResponseMessage.Key.ERROR_CONFLICTING_FIELD_CONFIGURATION,
            ResponseMessage.Message.ERROR_CONFLICTING_FIELD_CONFIGURATION),
    errorSystemSettingNotFound(ResponseMessage.Key.ERROR_SYSTEM_SETTING_NOT_FOUND,
            ResponseMessage.Message.ERROR_SYSTEM_SETTING_NOT_FOUND),
    errorNoRootOrgAssociated(ResponseMessage.Key.ERROR_NO_ROOT_ORG_ASSOCIATED,
            ResponseMessage.Message.ERROR_NO_ROOT_ORG_ASSOCIATED),
    errorInactiveCustodianOrg(ResponseMessage.Key.ERROR_INACTIVE_CUSTODIAN_ORG,
            ResponseMessage.Message.ERROR_INACTIVE_CUSTODIAN_ORG),
    errorUnsupportedCloudStorage(ResponseMessage.Key.ERROR_UNSUPPORTED_CLOUD_STORAGE,
    ...
    errorGenerateDownloadLink(ResponseMessage.Key.ERROR_GENERATE_DOWNLOAD_LINK,
            ResponseMessage.Message.ERROR_GENERATE_DOWNLOAD_LINK),
    errorUnavailableDownloadLink(ResponseMessage.Key.ERROR_DOWNLOAD_LINK_UNAVAILABLE,
            ResponseMessage.Message.ERROR_DOWNLOAD_LINK_UNAVAILABLE),
    errorSavingStorageDetails(ResponseMessage.Key.ERROR_SAVING_STORAGE_DETAILS,
            ResponseMessage.Message.ERROR_SAVING_STORAGE_DETAILS),
    errorCsvNoDataRows(ResponseMessage.Key.ERROR_CSV_NO_DATA_ROWS, ResponseMessage.Message.ERROR_CSV_NO_DATA_ROWS),
    errorInactiveOrg(ResponseMessage.Key.ERROR_INACTIVE_ORG, ResponseMessage.Message.ERROR_INACTIVE_ORG),
    errorDuplicateEntries(ResponseMessage.Key.ERROR_DUPLICATE_ENTRIES, ResponseMessage.Message.ERROR_DUPLICATE_ENTRIES),
    errorConflictingValues(ResponseMessage.Key.ERROR_CONFLICTING_VALUES,
            ResponseMessage.Message.ERROR_CONFLICTING_VALUES),
    errorConflictingRootOrgId(ResponseMessage.Key.ERROR_CONFLICTING_ROOT_ORG_ID,
            ResponseMessage.Message.ERROR_CONFLICTING_ROOT_ORG_ID),
    errorUpdateSettingNotAllowed(ResponseMessage.Key.ERROR_UPDATE_SETTING_NOT_ALLOWED,
            ResponseMessage.Message.ERROR_UPDATE_SETTING_NOT_ALLOWED),
    errorCreatingFile(ResponseMessage.Key.ERROR_CREATING_FILE, ResponseMessage.Message.ERROR_CREATING_FILE),
    errorProcessingRequest(ResponseMessage.Key.ERROR_PROCESSING_REQUEST,
    ...
    invalidTextbookName(ResponseMessage.Key.INVALID_TEXTBOOK_NAME, ResponseMessage.Message.INVALID_TEXTBOOK_NAME),
    duplicateRows(ResponseMessage.Key.DUPLICATE_ROWS, ResponseMessage.Message.DUPLICATE_ROWS),
    requiredHeaderMissing(ResponseMessage.Key.REQUIRED_HEADER_MISSING, ResponseMessage.Message.REQUIRED_HEADER_MISSING),
    requiredFieldMissing(ResponseMessage.Key.REQUIRED_FIELD_MISSING, ResponseMessage.Message.REQUIRED_FIELD_MISSING),
    blankCsvData(ResponseMessage.Key.BLANK_CSV_DATA, ResponseMessage.Message.BLANK_CSV_DATA),
    exceedMaxChildren(ResponseMessage.Key.EXCEEDS_MAX_CHILDREN, ResponseMessage.Message.EXCEEDS_MAX_CHILDREN),
    textbookChildrenExist(ResponseMessage.Key.TEXTBOOK_CHILDREN_EXISTS,
            ResponseMessage.Message.TEXTBOOK_CHILDREN_EXISTS),
    textbookUpdateFailure(ResponseMessage.Key.TEXTBOOK_UPDATE_FAILURE, ResponseMessage.Message.TEXTBOOK_UPDATE_FAILURE),
    noChildrenExists(ResponseMessage.Key.TEXTBOOK_CHILDREN_NOT_EXISTS,
            ResponseMessage.Message.TEXTBOOK_CHILDREN_NOT_EXISTS),
    textBookNotFound(ResponseMessage.Key.TEXTBOOK_NOT_FOUND, ResponseMessage.Message.TEXTBOOK_NOT_FOUND),
    errorProcessingFile(ResponseMessage.Key.ERROR_PROCESSING_FILE, ResponseMessage.Message.ERROR_PROCESSING_FILE),
    ...
    errorInvalidParameterSize(ResponseMessage.Key.ERROR_INVALID_PARAMETER_SIZE,
            ResponseMessage.Message.ERROR_INVALID_PARAMETER_SIZE),
    errorInvalidPageSection(ResponseMessage.Key.INVALID_PAGE_SECTION, ResponseMessage.Message.INVALID_PAGE_SECTION),
    errorRateLimitExceeded(ResponseMessage.Key.ERROR_RATE_LIMIT_EXCEEDED,
            ResponseMessage.Message.ERROR_RATE_LIMIT_EXCEEDED),
    errorInvalidDialCode(ResponseMessage.Key.ERROR_INVALID_DIAL_CODE, ResponseMessage.Message.ERROR_INVALID_DIAL_CODE),
    errorInvalidTopic(ResponseMessage.Key.ERROR_INVALID_TOPIC, ResponseMessage.Message.ERROR_INVALID_TOPIC),
    errorDialCodeDuplicateEntry(ResponseMessage.Key.ERROR_DIAL_CODE_DUPLICATE_ENTRY,
    ...
    errorDialCodeLinkingFail(ResponseMessage.Key.DIAL_CODE_LINKING_FAILED,
            ResponseMessage.Message.DIAL_CODE_LINKING_FAILED),
    errorDialCodeLinkingClientError(ResponseMessage.Key.ERROR_TEXTBOOK_UPDATE,
            ResponseMessage.Message.ERROR_TEXTBOOK_UPDATE),

    OK(200), CLIENT_ERROR(400), SERVER_ERROR(500), RESOURCE_NOT_FOUND(404), UNAUTHORIZED(401), FORBIDDEN(403),
    REDIRECTION_REQUIRED(302), TOO_MANY_REQUESTS(429);
    ...
    /**
     * This method will take header response code as int value and it provide
     * matched enum value, if code is not matched or exception occurs then it will
     * provide SERVER_ERROR
     *
     * @param code int
