...
public interface ResponseMessage {
    ...
    interface Message {
        ...
        String SMS_BODY_ERROR = "Sms Body is mandatory.";
        ...
        String USERNAME_EMAIL_IN_USE = "Username or Email is already in use. Please try with a different Username or Email.";
        ...
        String PHONE_VERIFY_ERROR = "Please provide a verified phone number in order to create/update user.";
        ...
        String USER_INACTIVE_FOR_THIS_ORG = "User is Inactive for this org. Please make it active to proceed.";
        ...
        String INVALID_LOCATION_DELETE_REQUEST = "One or more locations have a parent reference to given location and hence cannot be deleted.";
        ...
        String INVALID_PARAMETER_VALUE = "Invalid value {0} for parameter {1}. Please provide a valid value.";
        ...
        String CONFLICTING_ORG_LOCATIONS = "An organisation cannot be associated to two conflicting locations ({0}, {1}) at {2} level. ";
        ...
        String ROOT_ORG_ASSOCIATION_ERROR = "No root organisation found which is associated with given {0}.";
        ...
        String EXTERNALID_NOT_FOUND = "External ID (id: {0}, idType: {1}, provider: {2}) not found for given user.";
        String PARSING_FAILED = "Failed to parse {0}.";
        String EXTERNAL_ID_FORMAT = "externalId (id: {0}, idType: {1}, provider: {2})";
        String EXTERNALID_ASSIGNED_TO_OTHER_USER = "External ID (id: {0}, idType: {1}, provider: {2}) already assigned to another user.";
        String MANDATORY_CONFIG_PARAMETER_MISSING = "Mandatory configuration parameter {0} missing which is required for service startup.";
        String CASSANDRA_CONNECTION_ESTABLISHMENT_FAILED = "Cassandra connection establishment failed in {0} mode.";
        ...
        String ERROR_JSON_TRANSFORM_INVALID_TYPE_CONFIG = "JSON transformation failed as invalid type configuration found for field {0}.";
        String ERROR_JSON_TRANSFORM_INVALID_DATE_FORMAT = "JSON transformation failed as invalid date format configuration found for field {0}.";
        String ERROR_JSON_TRANSFORM_INVALID_INPUT = "JSON transformation failed as invalid input provided for field {0}.";
        String ERROR_JSON_TRANSFORM_INVALID_ENUM_INPUT = "JSON transformation failed as invalid enum input provided for field {0}.";
        String ERROR_JSON_TRANSFORM_ENUM_VALUES_EMPTY = "JSON transformation failed as enum values is empty in configuration for field {0}.";
        String ERROR_JSON_TRANSFORM_BASIC_CONFIG_MISSING = "JSON transformation failed as mandatory configuration (toFieldName, fromType or toType) is missing for field {0}.";
        String ERROR_JSON_TRANSFORM_INVALID_FILTER_CONFIG = "JSON transformation failed as invalid filter configuration found for field {0}.";
        ...
        String ERROR_REGISTRY_ACCESS_TOKEN_BLANK = "Request failed as user access token is not provided.";
        String DUPLICATE_EXTERNAL_IDS = "Duplicate external IDs for given idType ({0}) and provider ({1}).";
        String INVALID_DUPLICATE_VALUE = "Values for {0} and {1} cannot be same.";
        String EMAIL_RECIPIENTS_EXCEEDS_MAX_LIMIT = "Email notification is not sent as the number of recipients exceeded configured limit ({0}).";
        String NO_EMAIL_RECIPIENTS = "Email notification is not sent as the number of recipients is zero.";
        ...
        String ERROR_CONFIG_LOAD_EMPTY_STRING = "Loading {0} configuration failed as empty string is passed as parameter.";
        String ERROR_CONFIG_LOAD_PARSE_STRING = "Loading {0} configuration failed due to parsing error.";
        String ERROR_CONFIG_LOAD_EMPTY_CONFIG = "Loading {0} configuration failed.";
        String ERROR_CONFLICTING_FIELD_CONFIGURATION = "Field {0} in {1} configuration is conflicting in {2} and {3}.";
        ...
        String ERROR_CONFLICTING_ROOT_ORG_ID = "Root organisation ID of API user is conflicting with that of specified organisation ID.";
        ...
        String REQUIRED_FIELD_MISSING = "Required columns missing. Please check and upload again. Mandatory fields are: ";
        String BLANK_CSV_DATA = "Did not find any Table of Contents data. Please check and upload again.";
        ...
        String ERROR_RATE_LIMIT_EXCEEDED = "Your per {0} rate limit has exceeded. You can retry after some time.";
        ...
        String ERROR_DIAL_CODE_DUPLICATE_ENTRY = "Dial code {0} is associated with multiple identifier {1}.";
        String ERROR_DIAL_CODE_ALREADY_ASSOCIATED = "Dial code already associated with identifier {0} for given textbook.";
    ...
    interface Key {
        ...
        String SMS_BODY_ERROR = "SMS_BODY_ERROR";
        ...
        String ERROR_JSON_TRANSFORM_INVALID_FILTER_CONFIG = "ERROR_JSON_TRANSFORM_INVALID_FILTER_CONFIG";
